export default (function () {
  ...
  const loadRnnNoiseVad = (function () {
    var _scriptDir =
    ...
    return function (Module) {
      ...
      var wasmBinaryFile = "rnnoise-vad.wasm";
      ...
      var _rnnoise_process_frame_vad = (Module["_rnnoise_process_frame_vad"] =
        function () {
          return (_rnnoise_process_frame_vad = Module[
            "_rnnoise_process_frame_vad"
          ] =
  ...
  class VadWorklet extends AudioWorkletProcessor {
    constructor({ audioContext, processorOptions }) {
      ...
      const instantiateWasm = (imports, cb) =>
        WebAssembly.instantiate(rnnWasm, imports).then(({ instance }) =>
          cb(instance)
        );
